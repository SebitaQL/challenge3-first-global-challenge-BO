    ...
    if (finger_status==true)
    {
      ...
      if (lastIR > beforeIR)
      {
        ...
        if (!rising && rise_count > rise_threshold)
        {
          ...
          lcd.setCursor(9,1);
          if(c==0) lcd.print("R=?"); else lcd.print("R=" + String(avR) + " ");
          ...
          if(c > 4)
          {
            ...
            if(avBPM > 40 && avBPM <220)
            {
              lcd.print("         ");
              lcd.setCursor(0,0);
              lcd.print("bpm=" + String(avBPM)); //else lcd.print("---");
            }
          ...
          /*else
          {
            if(c <3)
            {
              ...
              lcd.setCursor(3,0); lcd.print( 2 ); //bpm ?
              lcd.setCursor(4,1); lcd.print( 2 ); //SpO2 ?
            }
          }*/
        }
      }
